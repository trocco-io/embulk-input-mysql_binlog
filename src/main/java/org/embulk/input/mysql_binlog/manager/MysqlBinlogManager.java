...
public class MysqlBinlogManager {
    ...
    public MysqlBinlogManager(PluginTask task){
        this.task = task;
        this.setDbInfo();
    ...
    private void registerHandler(){
        this.parser.registerHandler(new InsertEventHandler(this.tableManager), EventType.WRITE_ROWS, EventType.EXT_WRITE_ROWS, EventType.PRE_GA_WRITE_ROWS);
        this.parser.registerHandler(new UpdateEventHandler(this.tableManager), EventType.UPDATE_ROWS, EventType.EXT_UPDATE_ROWS, EventType.PRE_GA_UPDATE_ROWS);
        this.parser.registerHandler(new DeleteEventHandler(this.tableManager), EventType.DELETE_ROWS, EventType.EXT_DELETE_ROWS, EventType.PRE_GA_DELETE_ROWS);
