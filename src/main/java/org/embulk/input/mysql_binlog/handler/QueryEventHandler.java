...
public class QueryEventHandler implements BinlogEventHandler {
    private final Logger logger = LoggerFactory.getLogger(QueryEventHandler.class);
    ...
    private boolean shouldProcessQuery(String query, String tableName){
        try{
    ...
    private String normalizeQuery(String query, String databaseName, String tableName){
